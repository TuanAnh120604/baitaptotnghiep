...
// Nếu không có quyền nào → thông báo (tùy chọn)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($ma_phieu_nhap) || empty($ngay_nhap) || empty($ma_kho) || empty($hang_hoa)) {
        ...
        try {
            ...
            // Thêm phiếu nhập
            // Lưu ý: Cần thêm cột 'trang_thai' vào bảng phieu_nhap với giá trị mặc định 'cho_xac_nhan'
            // Nếu cột chưa tồn tại, hãy chạy: ALTER TABLE phieu_nhap ADD COLUMN trang_thai VARCHAR(20) DEFAULT 'cho_xac_nhan'

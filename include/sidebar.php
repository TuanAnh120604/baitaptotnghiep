            ...
            <div class="flex-1 overflow-y-auto py-4">
                <nav class="space-y-1 px-3">
                    ...
                    <?php if (canView('thongke')): ?>
                        <a class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" href="/baitaptotnghiep-main/index.php" onclick="closeAllMenus()">
                            <span class="material-icons-round text-xl mr-3">analytics</span>
                            Thống kê
                        </a>
                    <?php endif; ?>
                    <?php if (canView('loaikho') || canView('donvitinh') || canView('danhsachkho')): ?>
                        <div>
                            ...
                            <div id="khoMenu" class="mt-1 ml-3 space-y-1 hidden" aria-hidden="true">
                                ...
                                <?php endif; ?>
                                <?php if (canView('donvitinh')): ?>
                                    <a class="flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" href="/baitaptotnghiep-main/DonViTinh/donvitinh.php">
                                        <span class="w-3 h-3 rounded-full bg-primary/20 mr-3"></span>
                                        Đơn vị tính
                                    </a>
                                <?php endif; ?>
                    ...
                    <?php if (canView('thekho')): ?>
                        <a class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" href="/baitaptotnghiep-main/TheKho/thekho.php" onclick="closeAllMenus()">
                            <span class="material-icons-round text-xl mr-3">receipt_long</span>
                            Thẻ kho
                        </a>
                    <?php endif; ?>
                    <?php if (canView('phieunhap')): ?>
                        <a class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" href="/baitaptotnghiep-main/PhieuNhap/phieunhap.php" onclick="closeAllMenus()">
                            <span class="material-icons-round text-xl mr-3">input</span>
                            Phiếu nhập
                        </a>
                    <?php endif; ?>
                    <?php if (canView('phieuxuat')): ?>
                        <a class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" href="/baitaptotnghiep-main/PhieuXuat/phieuxuat.php" onclick="closeAllMenus()">
                    ...
                    <?php if (canView('nguoidung')): ?>
                        <a class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" href="/baitaptotnghiep-main/NguoiDung/nguoidung.php" onclick="closeAllMenus()">
            ...
            <div class="p-4 border-t border-border-light dark:border-border-dark">
                ...
                <div class="space-y-2">
                    <?php if (canView('caidat')): ?>
                        <a class="flex items-center w-full px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" href="/baitaptotnghiep-main/CaiDat/caidat.php" onclick="closeAllMenus()">
                            <span class="material-icons-round text-xl mr-3">settings</span>
                            Cài đặt
                        </a>
                    <?php endif; ?>
                    <a class="flex items-center w-full px-3 py-2 text-sm font-medium text-red-600 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors" href="/baitaptotnghiep-main/dn/logout.php">
